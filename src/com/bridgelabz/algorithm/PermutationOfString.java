...
public class PermutationOfString {
    /**
     *permutation by using iteration
     * using looping statements to iterations
     * */
    ...
    /**
     *permutation by using recursion
    ...
    public static void permutationRecursively(String word, String permutatedWord) {
        ...
        for (int index = 0; index < word.length(); index++) {
             ...
             * It achieve repitition by calling same function again
             */
